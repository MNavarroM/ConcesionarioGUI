...
public class Teclado{
	...
	/**
	*Comprueba si el usuario quiere continuar o no
	*@return continuar toma el valor true en caso de introducir S o s y false en caso contrario
	*/
	public static boolean continuar(String mensaje){
		boolean continuar;
		char caracterIntroducido = Teclado.leerCaracter(mensaje);
